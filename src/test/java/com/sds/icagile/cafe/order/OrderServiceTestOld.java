...
@Disabled(value = "PaymentService 분리 이전의 테스트")
public class OrderServiceTestOld {
    ...
    public void setUp() throws Exception {
        subject = new TestableOrderService(mockOrderRepository, mockMileageApiService, mockCustomerService, mockBeverageRepository, mockOrderItemRepository, mockPaymentService);
